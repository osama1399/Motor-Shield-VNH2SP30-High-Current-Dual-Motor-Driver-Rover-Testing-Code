...
iii. when user enter '4', dc motor start turning right and serial monitor will print Turning Right.
iv. when user enter '5', dc motor start turning left and serial monitor will print Turning Left.
v. when user enter '1', dc motor stop from rotating and serial monitor will print stop.
vi. when user enter '+', dc motor's speed increase by 10 and serial monitor will print the motor's speed. However, dc motor maximum speed is 255, thus, when user enter '++' more it will still print 255 and never more than 255 (as shown in the pic).
vii. when user enter '-', dc motor's speed decrease by 10 and serial monitor will print the motor's speed. However, dc motor minimum speed is 0, thus, when user enter '--' more it will still print 0 and never less than 0
